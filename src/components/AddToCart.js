  ...
  return (
    <div className="inline-flex my-2">
      ...
      <button
        ...
        style={{"background-color":"#4B0AA2"}}
        className="inline-block appearance-none border border-black text-white px-4 py-3 leading-tight rounded-none focus:outline-none ml-2"
        disabled={disabled}
      >
        Add to Cart
      </button>
